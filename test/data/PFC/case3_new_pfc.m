...
mpc.bus = [
	...
	2       2       400	0	0   0   1       1       0	345     1       1.1     0.9;
	3       1       200	0	0   0   1       1       0	345     1       1.1     0.9;
];
...
mpc.convdc = [
    1       1   1       1       -60    -40    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050    -58.6274   1.0079   0 500 -500 100 -100;
    2       2   2       1       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 500 -500 100 -100;
    3       3   1       1       35       5    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050     36.1856   0.9978   0 500 -500 100 -100;
];

%% branches
%column_names%   fbusdc  tbusdc  r      l        c   rateA   rateB   rateC   status
mpc.branchdc = [
    5       2       0.072   0   0    1000     1000     1000     1;
    2       3       0.072   0   0    1000     1000     1000     1;
    4       3       0.053   0   0    1000     1000     1000     1;
 ];
