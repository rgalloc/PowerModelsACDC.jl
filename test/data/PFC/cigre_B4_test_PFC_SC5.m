...
mpc.gen = [
    ...
    20    0  0   300 -300  1.02  100    1   3000    0;   % External grid B
...
mpc.busdc = [
    ...
    7      1     0    1       525     1.1    0.9    0   1; % PFC bus
    8      1     0    1       525     1.1    0.9    0   1; % PFC bus
    9      1     0    1       525     1.1    0.9    0   1; % PFC bus
    10     1     0    1       525     1.1    0.9    0   1; % PFC bus
];
...
mpc.branchdc = [
    ...
    3      7     0.00750   0  0    2000  2000  2000   1;
    8      6     0.00500   0  0    2000  2000  2000   1;
    4      9     0.00500   0  0    2000  2000  2000   1;
    3      4     0.00750   0  0    2000  2000  2000   1;
    3      10     0.00999   0  0    2000  2000  2000   1;
];
...
mpc.convdc = [
    1   1   2   1     0    0   0    1.02  0.010 0.050  1    1   0.01  0     0.010 0.050  0     400      1.10  0.90  1.20  1   0.010 0.010 0.002  0.002  0      0   1.00   0     2000  -2000  1000  -1000;
    2   2   3   1     0    0   0    1.02  0.010 0.050  1    1   0.01  0     0.010 0.050  0     400      1.10  0.90  1.20  1   0.010 0.010 0.002  0.002  0.010  0   1.00   0     2000  -2000  1000  -1000;
    5   3   1   1     0    0   0    0.98  0.010 0.100  1    1   0.01  0     0.010 0.050  0     220      1.10  0.90  1.20  1   0.010 0.010 0.002  0.002  0      0   1.00   0     2000  -2000  1000  -1000;
    6   4   1   1     0    0   0    0.98  0.010 0.100  1    1   0.01  0     0.010 0.050  0     220      1.10  0.90  1.20  1   0.010 0.010 0.002  0.002  0      0   1.00   0     2000  -2000  1000  -1000;
];
...
mpc.gencost = [
    ...
    2     0       0      3  0.002   88    0;   % Ext-grid B (onshore)
...
mpc.pfc = [
    5       7       8       -4     4    0.0     1.0     -2000    2000 1;
    6       9       10      -4     4    0.0     1.0     -2000    2000 1;
];